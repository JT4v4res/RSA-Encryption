...
Alan Turing's Cipher Competition Divulgation Image<br>
...
<br>
![](Cumberbatch.jpg)
Benedict Cumberbatch as Alan Turing in Imitation's Game, Alan Turing Biography Movie.
<br>

##Time for action!


We will show you here an implementation of the python RSA encryption algorithm and explain the math behind it.
<br>
...
- Now we calculate E, which will be a prime number to that generated by Phi (N).
...
```
<br>
And again, as we are dealing with very large numbers, we use the fast modular exponentiation function with binaries.
